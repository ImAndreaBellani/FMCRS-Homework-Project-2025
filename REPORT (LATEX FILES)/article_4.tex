...
%\let\thefootnote\relax\footnotetext{* \textit{Politecnico di Milano}}

%\let\thefootnote\relax\footnotetext{\textsuperscript{1} \textit{Formal Methods for Concurrent and Real-Time Systems (UIC 545)}}
