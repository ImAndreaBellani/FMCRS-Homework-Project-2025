...
\newcommand\ytl[2]{
	\parbox[b]{8em}{\hfill{\color{cyan}\bfseries\sffamily #1}~$\cdots\cdots$~}\makebox[0pt][c]{$\bullet$}\vrule\quad \parbox[c]{10cm}{\vspace{5pt}\color{red!40!black!80}\raggedright\sffamily #2.\\[5pt]}\\[-3pt]}
\usepackage{tabularx}
		...
		\subsection{Project development timeline}
			\begin{table}[h!]
				...
				\begin{minipage}[h!]{.8\linewidth}
					...
					\ytl{july 21st}{Finished report revision}
					\bigskip
					\rule{\linewidth}{1pt}%
				\end{minipage}
