...
\begin{document}
	...
	\section{Analysis of selected configurations}
		...
		\subsection{Stochastic version}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=.5\textwidth]{plots/SniperphobiaSEdevelopment.png}
			...
			\begin{figure}[h!]
				...
				\begin{minipage}{.4\textwidth}
					\centering
					\includegraphics[width=\linewidth]{plots/CannonphobiaSEdevelopment.png}
					\caption{Cannonphobia SE simulation with 10 runs}
				\end{minipage}
				\begin{minipage}{.5\textwidth}
					\centering
					\includegraphics[width=\linewidth]{plots/DownFromSnipersSEdevelopment.png}
			...
			\begin{figure}[h!]
				...
				\begin{minipage}{.4\textwidth}
					\centering
					\includegraphics[width=\linewidth]{plots/PD SA S.png}
					\caption{Sniperphobia SE probability distribution in the first 100 time units with 1000 runs}
				\end{minipage}
				\begin{minipage}{.5\textwidth}
					\centering
					\includegraphics[width=\linewidth]{plots/PD SA DFS.png}
			...
			\begin{figure}[h!]
				\centering
				\includegraphics[width=.7\textwidth]{plots/BETTER S.png}
