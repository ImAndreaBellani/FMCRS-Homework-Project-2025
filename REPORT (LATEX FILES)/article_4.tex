	...
	\section{Introduction}
		\subsection{Definitions}
			\begin{itemize}
				...
				\item \textbf{winning} configuration : in Vanilla version, a configuration is winning if, by setting it, a wave of 3 circles and 3 square can never defeat the MT;
		...
		\subsection{Project development timeline}
			\begin{table}[h!]
				...
				\begin{minipage}[h!]{.65\linewidth}
					...
					\ytl{july 9th}{Finished report writing}
					\bigskip
					\rule{\linewidth}{1pt}%
				\end{minipage}
